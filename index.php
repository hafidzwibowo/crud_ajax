				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form id="form">
							...
							<div class="form-group">
								<label>Nama</label>
								<input type="text" class="form-control" id="dataset_name" name="dataset_name" placeholder="Nama Dataset">
							</div>
							<div class="form-group">
								<label>Jenis Kelamin</label>
								<select id="status" name="status" class="form-control">
									<option value="">Pilih</option>
									<option value="validate">sudah divalidasi</option>
									<option value="unvalidate">belum divalidasi</option>
								</select>
							</div>
							<div class="form-group">
								<label>user_id</label>
								<input type="text" class="form-control" id="usser_id" name="user_id" placeholder="No. Telepon">
							</div>
							<div class="form-group">
								<label>directory_path</label>
								<textarea class="form-control" id="directory_path" name="directory_path" placeholder="Alamat"></textarea>
							</div>
							<!-- <div class="form-group">
								<label>Foto</label>
